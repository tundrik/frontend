                ...
                <div className="image-cover">
                    ...
                    <div className="lavres">
                        ...
                        <div className="award">
                            ...
                            <span className="aww">Агенство</span>
                    ...
                    <div className="cover-home">
                        <h1 className="cs hm">
                            <div className="h1-1">Агенство</div>
            ...
            <div className="content">
                <div className="about">
                    ...
                    <div className="book mrb-40">
                        ...
                        <div className="opium">
                            Мы используем автоматизацию совмесно с ручным контролем чтобы не пропустить подходящие
                            предложения для вас.
                        </div>
                    </div>
...
/*
Китонс базируется в Восточном Лондоне более 20 лет и с тех пор расширилась на север и юг города .
 Мы видели, как эти районы меняются до неузнаваемости, и тысячи объектов недвижимости приходят и уходят. 
 Наличие доступа к этому уровню знаний имеет большое значение.
У нас есть все необходимое, чтобы продвигать недвижимость на рынке.

Экспозиция
Мы не делаем вещи наполовину. Мы представлены на всех ведущих порталах по поиску недвижимости: Rightmove, Zoopla, Primelocation и OnTheMarket. 
Мы также покажем вашу недвижимость в витринах наших офисов по всему Лондону и проводим индивидуальные цифровые и печатные кампании для каждой
 недвижимости, которую мы берем на себя.
