...
import { FavoriteButton } from "../../Header"
...
const type_enum_options = [
    ...
    { value: GROUND, label: "Участки" },
    { value: COMMERCIAL, label: "Коммерция" },
]

const get_price_max_options = (node) => {
    const label = "Стоимость"
    return [
...
const square_ground_max_options = [
    { value: "undefined", label: "Площадь участка" },
        ...
        <div className="inter">
            <div className="content">
                <div className="filter">
                    ...
                    />
                    <Select name="sort" value={sort} event={(e) => handlerSelect(e, "sort")} options={sort_options} />
                </div>
            </div>
        </div>
    )
